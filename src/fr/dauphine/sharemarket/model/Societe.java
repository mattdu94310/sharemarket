...
@NamedQueries({
	...
	@NamedQuery(name="Societe.findById", query="SELECT s FROM Societe s where s.idSociete=:id"),
	@NamedQuery(name="Societe.findByName", query="SELECT s FROM Societe s where s.nom=:nom"),
	@NamedQuery(name="Societe.findByMembreSociete", query="SELECT s FROM Societe s where s.membreSocieteLogin=:membreSociete")
})
